package com.semtex.identity.infrastructure.out.persistence.adapter;

import com.semtex.identity.domain.model.User;
import com.semtex.identity.domain.port.out.UserRepositoryPort;
import com.semtex.identity.infrastructure.out.persistence.mapper.UserPersistenceMapper;
import com.semtex.identity.infrastructure.out.persistence.repository.UserJpaRepository;
